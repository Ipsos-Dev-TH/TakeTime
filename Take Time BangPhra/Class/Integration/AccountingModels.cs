...
namespace Take_Time_BangPhra.Integration
{
    ...
    // ══════════════════════════════════════════════════════════════
    // Employee Sync — POST /api/companies/{companyId}/payroll/employees/sync
    // ══════════════════════════════════════════════════════════════

    public class SyncEmployeeItem
    {
        public string ExternalId { get; set; }
    ...
    public class SyncEmployeesRequest
    {
        public string ExternalSystem { get; set; } = "TakeTime";
        public List<SyncEmployeeItem> Employees { get; set; } = new List<SyncEmployeeItem>();
    }

    public class SyncEmployeesResponse
    {
        public int Created { get; set; }
        public int Updated { get; set; }
        public int Skipped { get; set; }
        public int Total { get; set; }
        public List<SyncEmployeeResultItem> Results { get; set; }
    }

    public class SyncEmployeeResultItem
    {
        public string ExternalId { get; set; }
    ...
    // ══════════════════════════════════════════════════════════════
    // Payroll Run Sync — POST /api/companies/{companyId}/payroll/runs
    // ══════════════════════════════════════════════════════════════
    ...
    // ══════════════════════════════════════════════════════════════
    // PND.1 / Tax Filing — GET /api/companies/{companyId}/payroll/pnd1/{year}/{month}
    //                      GET /api/companies/{companyId}/tax-filing-export/pnd1
    // ══════════════════════════════════════════════════════════════

    public class Pnd1ReportResponse
    {
        ...
        public List<Pnd1ReportLine> Lines { get; set; }
    }

    public class Pnd1ReportLine
    {
        public string EmployeeCode { get; set; }
        public string CitizenId { get; set; }
    ...
    public class TaxFilingExportResult
    {
        public string FormCode { get; set; }
