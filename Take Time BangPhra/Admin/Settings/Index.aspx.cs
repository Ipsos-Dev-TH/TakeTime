...
namespace Take_Time_BangPhra.Admin.Settings
{
    ...
    public partial class SettingsIndex : Page
    {
        ...
        private List<Group> BuildCatalog()
        {
            ...
            acc.Items.Add(new Item("รับชำระเงินออนไลน์ (PaySo หลัก / Omise สำรอง)",
                "คีย์เกตเวย์, เปิด/ปิดรายช่องทาง (จอง กิจกรรม POS รูมเซอร์วิส), วงเงินประกันความเสียหาย + ดูรายการชำระเงิน",
            ...
            acc.Items.Add(new Item("ช่องทางชำระเงิน (ลูกค้า/พนักงานเห็นอะไร)",
                "แคตตาล็อกช่องทาง: โอน/QR, PaySo VISA · AMEX · พร้อมเพย์, เงินสด, ทดรองกรรมการ — ข้อความแนะนำ เงื่อนไข QR และนโยบายยกเลิกหลัก",
                ...
                false, null, Perm.SysPayment));
            acc.Items.Add(new Item("เงินประกันความเสียหาย",
                "โหมดรับเงินประกัน (โอน/เงินสด/กันวงเงินบัตร), วงเงินแนะนำ, **ตั้งวงเงินแยกรายห้องพัก** และดูเงินประกันที่ยังค้าง",
