...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="sd-wrap">
        <div class="sd-head">
            ...
            <p>
                ค่าเริ่มต้น: ลูกค้า<b>โอนเงินประกันเข้าบัญชีโรงแรม</b> บันทึกไว้ในระบบ (นอกเกตเวย์ — PaySo กันวงเงินบัตรไม่ได้)<br />
                เช็คเอาท์ไม่มีความเสียหาย = บันทึก "โอนคืน" · มีความเสียหาย = หักเฉพาะที่เสียหายจริงแล้วโอนคืนส่วนที่เหลือ ·
                เงินประกันไม่ใช่รายได้ ไม่ส่ง NextAcc
            </p>
        </div>
        ...
        <div class="sd-card">
            ...
            <div class="sub">ขึ้นกับโหมดที่เลือก — โหมดโอน/เงินสดไม่ต้องใช้เกตเวย์</div>
        ...
        <div class="sd-card">
            ...
            <div class="sd-row">
                <div class="sd-lbl"><b>วิธีรับเงินประกัน</b>
                    <small>โอน (แนะนำ) = ลูกค้าโอนเข้าบัญชีโรงแรม พนักงานบันทึกเลขอ้างอิง · กันวงเงินบัตร = ต้องใช้ Omise (PaySo ทำไม่ได้) · เงินสด = รับเงินสดเป็นหลัก</small></div>
                <div class="sd-in">
                    <asp:DropDownList ID="ddlMode" runat="server"
                        style="width:100%;max-width:340px;padding:9px 11px;border:1px solid #dbe1e7;border-radius:9px;font-size:14px;">
                        <asp:ListItem Value="TRANSFER" Text="โอนเข้าบัญชีโรงแรม (นอกเกตเวย์) — แนะนำ" />
                        <asp:ListItem Value="CASH" Text="เงินสดเป็นหลัก" />
                        <asp:ListItem Value="CARD_HOLD" Text="กันวงเงินบนบัตร (Omise เท่านั้น)" />
                    </asp:DropDownList>
                    <asp:Literal ID="litTransferInfo" runat="server" />
                </div>
            </div>
        ...
        <div class="sd-card">
            <h3>เงินประกันที่ยังค้างอยู่ตอนนี้</h3>
            <div class="sub">รายการที่ยังไม่ได้หักหรือคืน — จัดการต่อได้ที่หน้าเช็คเอาท์ของการจองนั้น</div>
