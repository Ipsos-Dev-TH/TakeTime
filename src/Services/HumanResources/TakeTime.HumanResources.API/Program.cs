...
builder.Host.UseSerilog((context, loggerConfig) =>
{
    loggerConfig
        ...
        .Enrich.WithProperty("Service", "HumanResources")
        .WriteTo.Console();
});
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "TakeTime HumanResources API",
        Version = "v1",
        Description = "API for employee management, leave requests, overtime tracking, and payroll processing."
    });
...
builder.Services.AddAuthentication("Bearer")
    .AddJwtBearer("Bearer", options =>
    {
        ...
        options.TokenValidationParameters = new Microsoft.IdentityModel.Tokens.TokenValidationParameters
        {
            ...
            ValidAudience = builder.Configuration["Identity:Audience"] ?? "taketime-hr-api"
        };
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "TakeTime HumanResources API v1");
    });
}
...
Log.Information("TakeTime HumanResources API starting up...");
